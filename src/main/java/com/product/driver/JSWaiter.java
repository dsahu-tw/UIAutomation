...
public class JSWaiter {
    ...
    public static ExpectedCondition angularHasFinishedProcessing() {
        ...
        return driver -> {
            ...
            Boolean result = (Boolean) jsexec.executeScript("return (window.angular != null) && (angular.element(document).injector() != null) && (angular.element(document).injector().get('$http').pendingRequests.length === 0)");
            System.out.println("Angular wait over "+result);
            return result;
        };
